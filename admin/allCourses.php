...
if(isset($_GET['del']))
{
    ...
    mysqli_query($conn,"delete from knp_courses where id = '".$_GET['id']."'");
    $msg = "<div class='alert alert-danger fade in'><a href=\"#\" class=\"close\" data-dismiss=\"alert\">&times;</a>One course deleted successfully!</div>";
}
...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>
                <i class="material-icons">assignment</i>Registered Courses
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                while ($row= mysqli_fetch_array($query))
                                {
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td width="16%"><?php echo $category ?></td>
                                        <td width="25%"><?php echo $faculty ?></td>
                                        <td width="30%"><?php echo $courseName ?></td>
                                        <td rowspan="1">
                                            ...
                                            <a href="block.php?student_id=<?php echo $id?>" ><button type="submit" name="block" class="btn btn-warning btn-xs" title="suspend user account"><i class="material-icons">block</i></button></a>
